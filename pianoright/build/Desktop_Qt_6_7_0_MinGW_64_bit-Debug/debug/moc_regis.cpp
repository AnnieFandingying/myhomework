...
struct qt_meta_stringdata_CLASSregisENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSregisENDCLASS = QtMocHelpers::stringData(
    "regis",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSregisENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject regis::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSregisENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSregisENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSregisENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<regis, std::true_type>,
        // method 'on_btn_regis_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_btn_quit_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void regis::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_btn_regis_clicked(); break;
...
void *regis::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSregisENDCLASS.stringdata0))
